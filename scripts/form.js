  ...
  if (orderRecall) {
    ...
    .then(data => {
      ...
      if (data.error == 1) {
        ...
        let resName = data.data.user.name;
        let resEmail = data.data.user.email;
        let resPhone = data.data.user.phone;
        let resOrder = data.data.order.order_id;
        let resCost = data.data.order.cost;
        let resPlanID = data.data.order.plan_id;
        let resOferta = data.data.org.oferta;
        let resPolicy = data.data.org.conf_policy;
        let resOrgName = data.data.org.org_name;
        let resOrgData = data.data.org.org_data;
    ...
    .then(data => {
      ...
      if (data.error == 1) {
        ...
        /* dspsdftv функцию для отправки данных */
        sendData();
